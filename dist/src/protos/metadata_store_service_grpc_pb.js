...
function serialize_ml_metadata_GetArtifactByTypeAndNameRequest(arg) {
    if (!(arg instanceof metadata_store_service_pb.GetArtifactByTypeAndNameRequest)) {
        throw new Error('Expected argument of type ml_metadata.GetArtifactByTypeAndNameRequest');
    }
    return Buffer.from(arg.serializeBinary());
}
function deserialize_ml_metadata_GetArtifactByTypeAndNameRequest(buffer_arg) {
    return metadata_store_service_pb.GetArtifactByTypeAndNameRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
function serialize_ml_metadata_GetArtifactByTypeAndNameResponse(arg) {
    if (!(arg instanceof metadata_store_service_pb.GetArtifactByTypeAndNameResponse)) {
        throw new Error('Expected argument of type ml_metadata.GetArtifactByTypeAndNameResponse');
    }
    return Buffer.from(arg.serializeBinary());
}
function deserialize_ml_metadata_GetArtifactByTypeAndNameResponse(buffer_arg) {
    return metadata_store_service_pb.GetArtifactByTypeAndNameResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_ml_metadata_GetContextByTypeAndNameRequest(arg) {
    if (!(arg instanceof metadata_store_service_pb.GetContextByTypeAndNameRequest)) {
        throw new Error('Expected argument of type ml_metadata.GetContextByTypeAndNameRequest');
    }
    return Buffer.from(arg.serializeBinary());
}
function deserialize_ml_metadata_GetContextByTypeAndNameRequest(buffer_arg) {
    return metadata_store_service_pb.GetContextByTypeAndNameRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
function serialize_ml_metadata_GetContextByTypeAndNameResponse(arg) {
    if (!(arg instanceof metadata_store_service_pb.GetContextByTypeAndNameResponse)) {
        throw new Error('Expected argument of type ml_metadata.GetContextByTypeAndNameResponse');
    }
    return Buffer.from(arg.serializeBinary());
}
function deserialize_ml_metadata_GetContextByTypeAndNameResponse(buffer_arg) {
    return metadata_store_service_pb.GetContextByTypeAndNameResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_ml_metadata_GetContextTypesRequest(arg) {
    if (!(arg instanceof metadata_store_service_pb.GetContextTypesRequest)) {
        throw new Error('Expected argument of type ml_metadata.GetContextTypesRequest');
    }
    return Buffer.from(arg.serializeBinary());
}
function deserialize_ml_metadata_GetContextTypesRequest(buffer_arg) {
    return metadata_store_service_pb.GetContextTypesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
function serialize_ml_metadata_GetContextTypesResponse(arg) {
    if (!(arg instanceof metadata_store_service_pb.GetContextTypesResponse)) {
        throw new Error('Expected argument of type ml_metadata.GetContextTypesResponse');
    }
    return Buffer.from(arg.serializeBinary());
}
function deserialize_ml_metadata_GetContextTypesResponse(buffer_arg) {
    return metadata_store_service_pb.GetContextTypesResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_ml_metadata_GetExecutionByTypeAndNameRequest(arg) {
    if (!(arg instanceof metadata_store_service_pb.GetExecutionByTypeAndNameRequest)) {
        throw new Error('Expected argument of type ml_metadata.GetExecutionByTypeAndNameRequest');
    }
    return Buffer.from(arg.serializeBinary());
}
function deserialize_ml_metadata_GetExecutionByTypeAndNameRequest(buffer_arg) {
    return metadata_store_service_pb.GetExecutionByTypeAndNameRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
function serialize_ml_metadata_GetExecutionByTypeAndNameResponse(arg) {
    if (!(arg instanceof metadata_store_service_pb.GetExecutionByTypeAndNameResponse)) {
        throw new Error('Expected argument of type ml_metadata.GetExecutionByTypeAndNameResponse');
    }
    return Buffer.from(arg.serializeBinary());
}
function deserialize_ml_metadata_GetExecutionByTypeAndNameResponse(buffer_arg) {
    return metadata_store_service_pb.GetExecutionByTypeAndNameResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_ml_metadata_GetLineageGraphRequest(arg) {
    if (!(arg instanceof metadata_store_service_pb.GetLineageGraphRequest)) {
        throw new Error('Expected argument of type ml_metadata.GetLineageGraphRequest');
    }
    return Buffer.from(arg.serializeBinary());
}
function deserialize_ml_metadata_GetLineageGraphRequest(buffer_arg) {
    return metadata_store_service_pb.GetLineageGraphRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
function serialize_ml_metadata_GetLineageGraphResponse(arg) {
    if (!(arg instanceof metadata_store_service_pb.GetLineageGraphResponse)) {
        throw new Error('Expected argument of type ml_metadata.GetLineageGraphResponse');
    }
    return Buffer.from(arg.serializeBinary());
}
function deserialize_ml_metadata_GetLineageGraphResponse(buffer_arg) {
    return metadata_store_service_pb.GetLineageGraphResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var MetadataStoreServiceService = exports.MetadataStoreServiceService = {
    ...
    getContextTypes: {
        ...
        requestStream: false,
        responseStream: false,
        requestType: metadata_store_service_pb.GetContextTypesRequest,
        responseType: metadata_store_service_pb.GetContextTypesResponse,
        requestSerialize: serialize_ml_metadata_GetContextTypesRequest,
        requestDeserialize: deserialize_ml_metadata_GetContextTypesRequest,
        responseSerialize: serialize_ml_metadata_GetContextTypesResponse,
        responseDeserialize: deserialize_ml_metadata_GetContextTypesResponse,
    },
    ...
    getArtifactByTypeAndName: {
        ...
        requestStream: false,
        responseStream: false,
        requestType: metadata_store_service_pb.GetArtifactByTypeAndNameRequest,
        responseType: metadata_store_service_pb.GetArtifactByTypeAndNameResponse,
        requestSerialize: serialize_ml_metadata_GetArtifactByTypeAndNameRequest,
        requestDeserialize: deserialize_ml_metadata_GetArtifactByTypeAndNameRequest,
        responseSerialize: serialize_ml_metadata_GetArtifactByTypeAndNameResponse,
        responseDeserialize: deserialize_ml_metadata_GetArtifactByTypeAndNameResponse,
    },
    ...
    getExecutionByTypeAndName: {
        ...
        requestStream: false,
        responseStream: false,
        requestType: metadata_store_service_pb.GetExecutionByTypeAndNameRequest,
        responseType: metadata_store_service_pb.GetExecutionByTypeAndNameResponse,
        requestSerialize: serialize_ml_metadata_GetExecutionByTypeAndNameRequest,
        requestDeserialize: deserialize_ml_metadata_GetExecutionByTypeAndNameRequest,
        responseSerialize: serialize_ml_metadata_GetExecutionByTypeAndNameResponse,
        responseDeserialize: deserialize_ml_metadata_GetExecutionByTypeAndNameResponse,
    },
    ...
    getContextByTypeAndName: {
        ...
        requestStream: false,
        responseStream: false,
        requestType: metadata_store_service_pb.GetContextByTypeAndNameRequest,
        responseType: metadata_store_service_pb.GetContextByTypeAndNameResponse,
        requestSerialize: serialize_ml_metadata_GetContextByTypeAndNameRequest,
        requestDeserialize: deserialize_ml_metadata_GetContextByTypeAndNameRequest,
        responseSerialize: serialize_ml_metadata_GetContextByTypeAndNameResponse,
        responseDeserialize: deserialize_ml_metadata_GetContextByTypeAndNameResponse,
    },
    ...
    getLineageGraph: {
        ...
        requestStream: false,
        responseStream: false,
        requestType: metadata_store_service_pb.GetLineageGraphRequest,
        responseType: metadata_store_service_pb.GetLineageGraphResponse,
        requestSerialize: serialize_ml_metadata_GetLineageGraphRequest,
        requestDeserialize: deserialize_ml_metadata_GetLineageGraphRequest,
        responseSerialize: serialize_ml_metadata_GetLineageGraphResponse,
        responseDeserialize: deserialize_ml_metadata_GetLineageGraphResponse,
    },
};
